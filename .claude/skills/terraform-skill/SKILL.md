...
- Basic Terraform/OpenTofu syntax questions (Codex knows this)
...
**How to use:** When you need detailed information on a topic, reference the appropriate guide. Codex will load it on demand to provide comprehensive guidance.
