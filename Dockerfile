...
RUN apt-get -y install git gcc gdb clang llvm autoconf cmake strace lsof iotop curl wget atop mtr blktrace valgrind nmap sysstat htop vim silversearcher-ag golang python lua5.2 jp2a
